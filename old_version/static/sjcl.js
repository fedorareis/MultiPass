    ...
    for (f = g = 0; !c[f]; f ^= l || 1, g = k[g] || 1)
      for (
        n = g ^ (g << 1) ^ (g << 2) ^ (g << 3) ^ (g << 4),
          ...
          d[n] = f,
          m = h[(e = h[(l = h[f])])],
          p = (0x1010101 * m) ^ (0x10001 * e) ^ (0x101 * l) ^ (0x1010100 * f),
          m = (0x101 * h[n]) ^ (0x1010100 * n),
          e = 0;
        4 > e;
        e++
      )
...
function t(a, b, c) {
  ...
  for (n = 0; n < m; n++)
    (h =
      a[e >>> 24] ^ q[(f >> 16) & 255] ^ u[(g >> 8) & 255] ^ x[b & 255] ^ d[p]),
      (k =
        a[f >>> 24] ^
        q[(g >> 16) & 255] ^
        u[(b >> 8) & 255] ^
...
sjcl.bitArray = {
  ...
  concat: function (a, b) {
    ...
    return 32 === d
      ? a.concat(b)
      : sjcl.bitArray.oa(b, d, c | 0, a.slice(0, a.length - 1));
  },
...
sjcl.hash.sha256 = function (a) {
  this.f[0] || this.aa();
  a
    ? ((this.l = a.l.slice(0)), (this.i = a.i.slice(0)), (this.h = a.h))
    : this.reset();
};
...
sjcl.hash.sha256.prototype = {
  ...
  aa: function () {
    ...
    for (var b = 0, c = 2, d, e; 64 > b; c++) {
      ...
      e &&
        (8 > b && (this.S[b] = a(Math.pow(c, 0.5))),
        (this.f[b] = a(Math.pow(c, 1 / 3))),
        b++);
    }
  },
  w: function (a) {
...
sjcl.mode.ocb2 = {
  ...
  encrypt: function (a, b, c, d, e, f) {
    ...
    for (g = 0; g + 4 < b.length; g += 4)
      (n = b.slice(g, g + 4)),
        (m = l(m, n)),
        (p = p.concat(l(c, a.encrypt(l(c, n))))),
        (c = h(c));
    n = b.slice(g);
    b = k.bitLength(n);
  ...
  decrypt: function (a, b, c, d, e, f) {
    ...
    for (c = 0; c + 4 < r / 32; c += 4)
      (n = k(m, a.decrypt(k(m, b.slice(c, c + 4))))),
        (l = k(l, n)),
        (q = q.concat(n)),
        (m = g(m));
    p = r - 32 * c;
...
sjcl.prng.prototype = {
  randomWords: function (a, b) {
    ...
    if (d & this.W) {
      ...
      for (
        g = 0;
        g < this.m.length &&
        ((e = e.concat(this.m[g].finalize())),
        (f += this.H[g]),
        (this.H[g] = 0),
        d || !(this.ba & (1 << g)));
        g++
      );
      this.ba >= 1 << this.m.length &&
        (this.m.push(new sjcl.hash.sha256()), this.H.push(0));
      this.s -= f;
      f > this.I && (this.I = f);
      this.ba++;
      ...
      for (
        d = 0;
        4 > d && ((this.A[d] = (this.A[d] + 1) | 0), !this.A[d]);
        d++
      );
    }
    for (d = 0; d < a; d += 4)
      0 === (d + 1) % this.sa && v(this),
        (e = w(this)),
  ...
  addEntropy: function (a, b, c) {
    ...
    this.s += b;
    h === this.K &&
      (this.isReady() !== this.K && z('seeded', Math.max(this.I, this.s)),
      z('progress', this.getProgress()));
  },
  isReady: function (a) {
    a = this.ea[void 0 !== a ? a : this.Z];
    return this.I && this.I >= a
      ? this.H[0] > this.ra && new Date().valueOf() > this.na
        ? this.W | this.V
        : this.V
      : this.s >= a
        ? this.W | this.K
  ...
  startCollectors: function () {
    if (!this.R) {
      ...
      if (window.addEventListener)
        window.addEventListener('load', this.c.loadTimeCollector, !1),
          window.addEventListener('mousemove', this.c.mouseCollector, !1),
          window.addEventListener('keypress', this.c.keyboardCollector, !1),
          window.addEventListener(
            'devicemotion',
            this.c.accelerometerCollector,
            !1,
          ),
          window.addEventListener('touchmove', this.c.touchCollector, !1);
  ...
  stopCollectors: function () {
    this.R &&
      (window.removeEventListener
        ? (window.removeEventListener('load', this.c.loadTimeCollector, !1),
          window.removeEventListener('mousemove', this.c.mouseCollector, !1),
          window.removeEventListener('keypress', this.c.keyboardCollector, !1),
          window.removeEventListener(
            'devicemotion',
            this.c.accelerometerCollector,
            !1,
          ),
          window.removeEventListener('touchmove', this.c.touchCollector, !1))
...
sjcl.json = {
  ...
  za: function (a, b, c, d) {
    ...
    d = d || {};
    var e = sjcl.json,
      f = e.u({ iv: sjcl.random.randomWords(4, 0) }, e.defaults),
      g;
    e.u(f, c);
    c = f.adata;
...
sjcl.bn.prototype = {
  ...
  powermod: function (a, b) {
    ...
    for (
      var d, e = a.normalize().trim().limbs, f = new this.j(1), g = this, c = 0;
      c < e.length;
      c++
    )
  ...
  montpowermod: function (a, b) {
    ...
    function d(a, c) {
      ...
      for (d = 0; d < e.limbs.length; d++)
        0 < d && (e.limbs[d - 1] |= (e.limbs[d] & f) << (g - l - 1)),
          (e.limbs[d] >>= l + 1);
    ...
    for (var r = new sjcl.bn(0), q = k.copy(); q.greaterEquals(1); )
      q.halveM(),
        0 == (f.limbs[0] & 1)
          ? (f.halveM(), r.halveM())
          : (f.addM(p), f.halveM(), r.halveM(), r.addM(n));
    f = f.normalize();
    r = r.normalize();
    n.doubleM();
    p = n.mulmod(n, b);
...
sjcl.ecc.point.prototype = {
  ...
  multiples: function () {
    ...
    if (void 0 === this.ma)
      for (
        c = this.toJac().doubl(),
          a = this.ma = [new sjcl.ecc.point(this.curve), this, c.toAffine()],
          b = 3;
        16 > b;
        b++
      )
...
sjcl.ecc.pointJac = function (a, b, c, d) {
  void 0 === b
    ? (this.isIdentity = !0)
    : ((this.x = b), (this.y = c), (this.z = d), (this.isIdentity = !1));
  this.curve = a;
};
sjcl.ecc.pointJac.prototype = {
  add: function (a) {
    ...
    if (c.equals(0))
      return this.y.equals(a.y.mul(b.mul(this.z)))
        ? this.doubl()
        : new sjcl.ecc.pointJac(this.curve);
  ...
  toAffine: function () {
    ...
    return new sjcl.ecc.point(
      this.curve,
      this.x.mul(b).fullReduce(),
      this.y.mul(b.mul(a)).fullReduce(),
    );
  },
  mult: function (a, b) {
    'number' === typeof a
      ? (a = [a])
      : void 0 !== a.limbs && (a = a.normalize().limbs);
    var c,
      d,
  ...
  mult2: function (a, b, c, d) {
    ...
    'number' === typeof c
      ? (c = [c])
      : void 0 !== c.limbs && (c = c.normalize().limbs);
    var e,
    ...
    for (d = Math.max(a.length, c.length) - 1; 0 <= d; d--)
      for (
        h = a[d] | 0, k = c[d] | 0, e = sjcl.bn.prototype.radix - 4;
        0 <= e;
        e -= 4
      )
        f = f
  ...
  isValid: function () {
    ...
    return this.y
      ...
      .equals(
        this.curve.b
          .mul(a)
          .add(this.x.mul(this.curve.a.mul(b).add(this.x.square()))),
      );
  },
};
...
sjcl.ecc.curve.prototype.fromBits = function (a) {
  ...
  a = new sjcl.ecc.point(
    this,
    this.field.fromBits(b.bitSlice(a, 0, c)),
    this.field.fromBits(b.bitSlice(a, c, 2 * c)),
  );
...
sjcl.ecc.basicKey.generateKeys = function (a) {
  return function (b, c, d) {
    b = b || 0x100;
    if ('number' === typeof b && ((b = sjcl.ecc.curves['c' + b]), void 0 === b))
      throw new sjcl.exception.invalid('no such curve');
...
sjcl.keyexchange.srp = {
  ...
  Ba: function () {
    ...
    for (a = 0; a < sjcl.keyexchange.srp.ka.length; a++)
      (b = sjcl.keyexchange.srp.ka[a].toString()),
        (b = sjcl.keyexchange.srp.la[b]),
        (b.N = new sjcl.bn(b.N)),
        (b.g = new sjcl.bn(b.g));
